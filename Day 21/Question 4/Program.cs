...
//Q4. Try some of the LinQ question given before
namespace ConsoleApplication75
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           var rs = (from c in m1.EmpDemoes select c).Count<EmpDemo>();
           Console.WriteLine("Number of Employees = {0}",rs);

           var mx = (from cs in m1.EmpDemoes select cs.Salary).Max();
           Console.WriteLine("Maximum Salary = {0}",mx);
        }
