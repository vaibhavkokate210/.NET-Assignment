...
namespace ConsoleApplication68
{
    class BussinessLayer
    {
        ...
        //    {
        //        con = getconnection();
        //        SqlCommand cmd = new SqlCommand("storedata", con);
        //        cmd.CommandType = System.Data.CommandType.StoredProcedure;
        //        cmd.Parameters.AddWithValue("@eid", e.Id);
        //        cmd.Parameters.AddWithValue("@ename", e.Name);
        //        cmd.Parameters.AddWithValue("@esalary", e.Salary);
        //        con.Open();
        ...
        public void badal(int id, string name)
        {
            SqlConnection con = null;
            try
            {
                con = getconnection();
                SqlCommand sl = new SqlCommand("change", con);
                sl.CommandType = System.Data.CommandType.StoredProcedure;
                sl.Parameters.AddWithValue("@eid", id);
                sl.Parameters.AddWithValue("@ename", name);
                con.Open();
                int j = sl.ExecuteNonQuery();
